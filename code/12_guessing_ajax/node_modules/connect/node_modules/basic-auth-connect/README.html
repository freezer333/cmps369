...
<h1 id="simgr-simple-image-resizer-build-status-https-travis-ci-org-expressjs-basic-auth-connect-png-https-travis-ci-org-expressjs-basic-auth-connect-">simgr - Simple Image Resizer <a href="https://travis-ci.org/expressjs/basic-auth-connect"><img src="https://travis-ci.org/expressjs/basic-auth-connect.png" alt="Build Status"></a></h1>
<p>Connect&#39;s Basic Auth middleware in its own module. This module is considered deprecated. You should instead create your own middleware with <a href="https://github.com/visionmedia/node-basic-auth">basic-auth</a>.</p>
<h2 id="api">API</h2>
<pre><code class="lang-js">var basicAuth = require(&#39;basic-auth-connect&#39;);
</code></pre>
<p>Sorry, couldn&#39;t think of a more clever name.</p>
