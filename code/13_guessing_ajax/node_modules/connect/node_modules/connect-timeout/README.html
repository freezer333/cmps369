...
<p>Previously <code>connect.timeout()</code>.</p>
<p>Usage:</p>
<pre><code class="lang-js">var app = require(&#39;connect&#39;);
app.use(require(&#39;timeout&#39;)(300))
</code></pre>
<h2 id="api">API</h2>
<h3 id="fn-timeout-ms-">fn = timeout(ms)</h3>
<p>Returns middleware that times out in <code>ms</code> milliseconds.</p>
